...
public class MainActivity extends AppCompatActivity {
    ...
    private class RetainedAppData {
        ...
        private WeatherRestAdapter mGetWeatherRestAdapter; // REST Adapter
        ...
        public void runRetrofitTestAsync (final String city) {
            ...
            if (mGetWeatherRestAdapter == null)
                mGetWeatherRestAdapter = new WeatherRestAdapter();
            mGetWeatherRestAdapter.WeatherApiAsync(city, mWeatherDataCallback); // Call Async API
        }
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        // you think.
                        WeatherData data = mGetWeatherRestAdapter.WeatherApiSync(city);
